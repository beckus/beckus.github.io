...
if(isset($_POST['email'])) {
    ...
    $email_good_subject = "Email from abeckus.com contact form";
    $email_spam_subject = "SPAM EMAIL from abeckus.com contact form";
    ...
    if(empty($website)) {
        $email_subject = $email_good_subject;
    } else {
        $email_subject = $email_spam_subject;
    }
